  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="login-form" role="form" action="j_spring_security_check" method="POST">
          <span class="errorMsg" id="login-error-container"></span>
          <input type="text" id="login-username" name='j_username' placeholder="手机号码" class="model-input" />
          <input type="password" id="login-password" name='j_password' placeholder="密码" class="model-input" />
